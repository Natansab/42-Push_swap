...
/*   Updated: 2017/02/08 15:45:57 by nsabbah          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	move_min_to_b(t_list **start_a, t_list **start_b,
			int content, char *opsresult)
{
	int distance;
...
void	ft_small_algo_two(t_list *start_a, char *opsresult,
			t_min min, t_list **start_b)
{
	if (ft_abs(ft_dist(start_a, min.one)) <=
		ft_abs(ft_dist(start_a, min.two)) + 1)
	{
...
void	ft_small_algo(t_list *start_a, char *opsresult)
{
	...
	else
	{
		...
		ft_small_algo_two(start_a, opsresult, min, start_b);
	}
	free(start_b);
}
